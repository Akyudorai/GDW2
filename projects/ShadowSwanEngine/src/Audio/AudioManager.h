...
public:
	...
	static FMOD::Studio::Bank* LoadBank(const std::string& filename, FMOD_STUDIO_LOAD_BANK_FLAGS flags);
	

	static void LoadEvent(const std::string& eventName);
	static void PlayEvent(const std::string& eventName);
	static void StopEvent(const std::string& eventName, bool bImmediate);

	static void GetEventParameter(const std::string& eventName, const std::string& paramName, float* param);
	static void SetEventParameter(const std::string& eventName, const std::string& paramName, float value);
