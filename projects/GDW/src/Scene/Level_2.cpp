...
bool Level_2::OnCreate()
{
	...
	wall_1.transform.m_pos = glm::vec3(-2.5f, 0.5f, 1.0f);
...
void Level_2::Render() const
{

}

void Level_2::HandleEvents()
{

}

void Level_2::OnResizeWindow(int width, int height)
{
